...
= 2.2.9 - Sep 04, 2024 =
* Fix: The add to cart in a quick view was clickable before selecting a variation.
* Fix The rating start style issue in a quick view of the product shown with the product slider plugin.
